...
void rfal()
{
  ...
  Serial.println(rdgelen);  
    //  if(rdgelen == "THS1ONAA") digitalWrite(LED_BUILTIN, HIGH);
      if(rdgelen == "TEUPS1ON") digitalWrite(sw1, HIGH);
      if(rdgelen == "TEUPS1OF") digitalWrite(sw1, LOW);

      if(rdgelen == "TEUPS2ON") digitalWrite(sw2, HIGH);
      if(rdgelen == "TEUPS2OF") digitalWrite(sw2, LOW);

      if(rdgelen == "TEUPS3ON") digitalWrite(sw3, HIGH);
      if(rdgelen == "TEUPS3OF") digitalWrite(sw3, LOW);

      if(rdgelen == "TEUPS4ON") digitalWrite(sw4, HIGH);
      if(rdgelen == "TEUPS5OF") digitalWrite(sw4, LOW);

      if(rdgelen == "TEUPS5ON") digitalWrite(sw5, HIGH);
      if(rdgelen == "TEUPS5OF") digitalWrite(sw5, LOW);
