  //WORK OFİS için 1 nol aydınlatma
...
{ pinMode(lamba, OUTPUT);
  ...
  digitalWrite(LED_BUILTIN, LOW);
   digitalWrite(lamba, LOW);
        Serial.begin(115200);
  if (!driver.init()) Serial.println("FWRFOFAA");
...
void rfal()
{
    ...
    {      
       ...
       if(rdgelen == "TWOFL1ON")  digitalWrite(lamba, HIGH);
       if(rdgelen == "TWOFL1OF") digitalWrite(lamba, LOW);
